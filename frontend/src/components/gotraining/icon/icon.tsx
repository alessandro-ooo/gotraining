...
const SettingsIcon: IconType = ({ className, color }) => {
  return (
    <svg
      width="24"
      height="24"
...
const LoadIcon: IconType = ({ className, color }) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      />
      <path
        d="M16 14C15.4696 14 14.9609 14.2107 14.5858 14.5858C14.2107 14.9609 14 15.4696 14 16"
        stroke={color || "#E5E5E5"}
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M20 14C20.5304 14 21.0391 14.2107 21.4142 14.5858C21.7893 14.9609 22 15.4696 22 16"
        stroke={color || "#E5E5E5"}
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M20 22C20.5304 22 21.0391 21.7893 21.4142 21.4142C21.7893 21.0391 22 20.5304 22 20"
        stroke={color || "#E5E5E5"}
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M16 22C15.4696 22 14.9609 21.7893 14.5858 21.4142C14.2107 21.0391 14 20.5304 14 20"
        stroke={color || "#E5E5E5"}
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
